      ...
      {loading ? (
        ...
        <Container fluid className="whitebg">
          <Container className="a-response-wrapper">
              ...
              <Row>
                <Col xs={12} md={7} sm={12}>
                  <h2 className="bigText blackText">
                    Our Online <br /> Courses
                  </h2>
                </Col>
                <Col xs={12} md={5} sm={12}>
                  <div className="a-wwa-caption smallestText blackText pt-2">
                    We host top instructors from design industry to teach
                    students how to become professionals. Here are some
                    available courses. You can get started today.
                  </div>
                </Col>
              </Row>
            </Col>
            ...
            <Col
              md={{ span: 10, offset: 1 }}
              className="align-center pt-5 pb-5"
            >
              <Row>
                  ...
                  <Row>
                    ...
                    <Col md={6} sm={12} className="ptsm">
                      ...
                      <div className="white smallestText pb-4">
                        <span className="line-through p-2 greenbg">
                          ₦20,000
                        </span>
                        <span className="p-2 greenbg ml-2">₦10,000</span>
                      </div>
                      <span className="smallestText blackText">
                        With 7 modules and over 20 videos of hands-on crucial
                        process in Design. Everything from how to start as a
                        beginner, becoming a pro, getting clients and more.
                      </span>
                    </Col>
                ...
                <Col md={6} sm={12} className="ptsm">
                  <Row>
                    ...
                    <Col md={6} sm={12}>
                      ...
                      <span className="smallestText blackText">
                        Explore user interface and user experience design that
                        will teach you the basics of UI/UX design and how to use
                        Adobe XD and Figma.
                      </span>
                    </Col>
                    <div className="pt-3 pbsm">
                ...
                <Col md={6} sm={12} className="pt-md-5 ptsm">
                  <Row>
                    ...
                    <Col md={6} sm={12}>
                      ...
                      <span className="smallestText blackText">
                        Explore user interface and user experience design that
                        will teach you the basics of UI/UX design and hoe to use
                        Adobe XD and Figma.
                      </span>
                    </Col>
                    <div className="pt-3 pbsm">
                  ...
                  <Row>
                    ...
                    <Col md={6} sm={12}>
                      ...
                      <span className="extraSmallText blackText">
                        --After the out cry of Men towards our to women... We
                        decided to take the men on how to build a portfolio site
                        without any code using Disha, Google site and Paystack.
