...
export default function Raeanna() {
          ...
          <Container className="">
              ...
              <Row className="pt-5 pb-5">
                ...
                <Col xs={12} md={6} sm={12}>
                  <div className="a-wwa-caption smallestText blackText b4 montserrat text-justify">
                    ...
                    size and track record. The website design is severely
                    limited and is currently lacking in the finesse and class
                    that a custom built website exudes.
                  </div>
                </Col>
                <Col xs={12} md={6} sm={12}>
                  <div className="a-wwa-caption smallestText blackText b4 montserrat text-justify">
                    Similar to its LinkedIn, Facebook and Twitter posts, RNL’s
                    engagement on these platforms indicates limitations as well.
                    There is an absence of tastefully designed e-flyers and
                ...
                <Col md={{ span: 6, offset: 1 }}>
                  ...
                  <Col md={{ span: 10, offset: 1 }} className="pt-4">
                    ...
                    <span className="white montserrat smallestText">
                      <span className="b8 montserrat smallestText">
                        1. Redesign your website
                      </span>
                      <br />
                      We implemented top notch UI/UX and providing content that
                      positively glows with RNL’s unique value proposition
                    </span>
                  </Col>
                </Col>
                <Col md={4}>
            ...
            <Col>
              <Row>
                ...
                <Col
                  md={5}
                  className="pt-4  smallestText blackText b4 montserrat text-justify"
                >
                  {/* <h2 className="bigText">
                  ...
                  <span className="smallestText blackText b4 montserrat text-justify">
                    ...
                    <br />
                    Create compelling content that impresses the authority of{" "}
                    <br /> the RNL brand and communicates the company’s value
                    <br /> proposition.
                  </span>
                  <br />
                  <br />
                  <span className="smallestText blackText b4 montserrat text-justify">
                    ...
                    <br />
                    We assisted with management of RNL’s customer <br />
                    engagement platforms, including website and social media.
                  </span>
                  <br />
                  <br />
                  <span className="smallestText blackText b4 montserrat text-justify">
                    <span className="b8 montserrat smallestText">
                      5. Other Design Services
                    </span>
                    <br />
                    Provide such other design and branding services that the{" "}
                    <br />
                    company requires.
                  </span>
                  <br />
