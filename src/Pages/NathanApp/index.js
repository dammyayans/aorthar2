              ...
              <Row className="pt-5">
                ...
                <Col xs={12} md={6} sm={12}>
                  <div className="a-wwa-caption smallestText blackText b4 montserrat text-justify">
                    Nathan App - an ecommerce mobile application. We are very
                    known for interface designs especially when you want to make
                    it high profile type. Our team carried out this distinct and
                    usable applications along side research and User Experience
                  </div>
                </Col>
              </Row>
            </Col>
            ...
            <Col md={{ span: 10, offset: 1 }} sm={{ span: 10, offset: 1 }}>
              <Row className="pt-5">
                ...
                <Col
                  ...
                  md={6}
                  sm={12}
                  className="montserrat smallestText blackText text-justify"
                >
                  <span className="">
                    <span className="b8">1. Interpreting Project Brief</span>
                    <br />
                    ...
                    them existing products in line with their market to get
                    their feedback.
                  </span>
                  <br />
                  <br />
                  <span>
                    <span className="b8">2. Research</span>
                    <br />
                    Our Design Team Kept their eyes on the latest UI trends,
                    design principles and your existing user experience
                    guidelines. While doing our research, we started exploring
                    the possibilities in layouts and options to provide the
                    desired experience. We studied their competitors’
                    approaches, similar features in their market, checked up
                    latest UI/UX trends, to establish a good UX guidelines.
                  </span>
                  <br />
                  <br />
                  <span>
                    <span className="b8">3. Wireframes and Sketch</span>
                    <br />
                    Our team engaged in paper sketches, white board flows and
                    wireframes to share with our client before going forward to
              ...
              <Row>
                <Col md={6} sm={12}>
                  <div className="smallestText blackText b4 montserrat pt-4 text-justify">
                    <span className="b8">4. Design</span>
                    <br />
                    We finally got to define the layout and flow of the required
                    interface, we created mockups to great-looking images with
                    theme and styles applied to them. We prepared and shared the
                    design specifications (principles, guidelines, colors,
                    typography, iconography) to Development team
                  </div>
                </Col>

                <Col md={6} sm={12}>
                  <div className="smallestText blackText b4 montserrat pt-4 text-justify">
                    <span className="b8">5. Implement and Development</span>
                    <br />
                    Our technical team started with the implementation of the
                    whole interface. The Development Team built back end
                    functionality first and connects it with UI. The
                    Implementation of back-end functionality and front interface
                    started with complete functionality and experience.
                  </div>
                </Col>
              </Row>
            </Col>
              ...
              <Row className="pt-4 pb-4">
                <Col sm={6}>
                  ...
                  <div className="smallestText blackText b4 montserrat pt-4 text-justify">
                    ...
                    visual language used to represent features, functionality,
                    or content. Icons are meant to be simple, visual elements
                    that are recognized and understood immediately.
                  </div>
                </Col>
                <Col sm={6}>
              ...
              <Row>
                <Col sm={6}>
                  <Row>
                    ...
                    <Col
                      md={10}
                      className="smallestText blackText b4 montserrat pb-3 text-justify smt"
                    >
                  ...
                  <Row>
                    ...
                    >
                      ...
                      We never assumed they know or they think they understand
                      the icon meanings; that was the result from the survey,
                      engaging conversation, and testing.
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col
                      ...
                      className="smallestText blackText b4 montserrat pb-3 text-justify smt"
                    >
                      We used a collection (family) of icons that all look and
                      feel as if they belong with each other creates a degree of
                      consistency, which equals uniformity. Integrating this
                      into an organisation’s style guide emits a strong brand
                      identity.
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col
                      md={10}
                      className="smallestText blackText b4 montserrat pt-md-2 pb-md-3 text-justify smt"
                    >
                      The scale of our work dictates what the combination of
                      icon and words get our message across faster. Icons have
                      the unique ability of breaking down language barriers, we
